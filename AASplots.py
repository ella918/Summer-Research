...
rejectionsamples = tj.JokerSamples.read('/data2/labs/douglste-laf-lab/mathewea/200.0M_new/2128145544872361984/rejection_samples_200.0M_2128145544872361984_new.hdf5')
...
fig1.savefig('initialRV_finalpres.png')
...
fig4.savefig('posorbits_finalpres.png')
