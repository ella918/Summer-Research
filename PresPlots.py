...
prior = 'DATA_PATH/200.0M_new/prior_samples_200M_new.hdf5'
rejectionsamples = 'DATA_PATH/200.0M_new/rejection_samples_200.0M_2128145544872361984_new.hdf5'
...
with quantity_support():
    ...
    ax2.set_ylabel("$e$")
    plt.title("200 Million Prior Samples")
fig2.savefig('Prior_finalpres.png')
print('Prior Plotted')
